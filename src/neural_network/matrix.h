...
/**
 * @brief Creates a new matrix with the specified number of rows and columns, filled with random values.
 * 
 * @param line_count The number of rows in the matrix.
 * @param column_count The number of columns in the matrix.
 * @return A pointer to the newly allocated matrix.
...
/**
 * @brief Creates a new matrix with the specified number of rows and columns, filled with zeros.
 * 
 * @param line_count The number of rows in the matrix.
 * @param column_count The number of columns in the matrix.
 * @return A pointer to the newly allocated matrix.
...
/**
 * @brief Sets the element of the matrix at the specified row and column with the given value.
 * 
...
/**
 * @brief Multiplies a matrix by a double-precision factor and stores the result in another matrix.
 * 
